...
<p>
  💻 OS en Python se refiere al módulo estándar que proporciona una manera de usar 
  funcionalidades dependientes del sistema operativo. 📂 Este módulo permite interactuar 
  con el sistema de archivos, manejar procesos, trabajar con variables de entorno y realizar 
  otras operaciones relacionadas con el sistema operativo de manera portable y eficiente.
</p>
